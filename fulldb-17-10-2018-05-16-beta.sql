-- Generation time: Wed, 17 Oct 2018 05:16:22 +0000
...
DROP TABLE IF EXISTS `courses_professors_info`;
CREATE TABLE `courses_professors_info` (
  `course_professor_info_id` int(11) NOT NULL AUTO_INCREMENT,
  `course_code` char(7) NOT NULL,
  `name_of_course` varchar(50) NOT NULL,
  `description` varchar(300) NOT NULL,
  `faculty_id` int(11) NOT NULL,
  `start_date` date NOT NULL,
  PRIMARY KEY (`course_professor_info_id`),
  KEY `faculty_id` (`faculty_id`),
  KEY `course_code` (`course_code`),
  KEY `course_code_2` (`course_code`) USING BTREE,
  KEY `faculty_id_2` (`faculty_id`) USING BTREE,
  CONSTRAINT `faculty_id` FOREIGN KEY (`faculty_id`) REFERENCES `professor` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;

INSERT INTO `courses_professors_info` VALUES ('1',' HUM101','nam','Dolores omnis omnis assumenda eos ut sint. Consectetur incidunt magni eum ipsum. Modi voluptas laboriosam est quisquam.','3','2018-01-28'),
...
INSERT INTO `professor` VALUES ('1','Pro','David','Olson','JOURNALISM','yes'),
...
CREATE TABLE `student_course_info` (
  ...
  KEY `course_code` (`course_code`),
  CONSTRAINT `course_code` FOREIGN KEY (`course_code`) REFERENCES `courses_professors_info` (`course_code`),
  CONSTRAINT `student_id` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `student_course_info` VALUES ('1',' MED101','2007-08-07','6'),
...
INSERT INTO `students` VALUES ('1','Elsie','Ruecker','1998-07-13','ENROLLED'),
